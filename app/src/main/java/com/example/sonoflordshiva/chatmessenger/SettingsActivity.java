...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        /*(AFTER "imageUri = data.getData();" line no. 176)
                            ...
                            mUserDatabase.child("image").setValue(download_url).addOnCompleteListener(new OnCompleteListener<Void>()
                            {
                                ...
                                public void onComplete(@NonNull Task<Void> task)
                                {
                                    if(task.isSuccessful()) {
                                        ...
                                        Toast.makeText(SettingsActivity.this, "Successful Uploading", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });

                            Toast.makeText(SettingsActivity.this, "Image setup successfully", Toast.LENGTH_SHORT).show();
                            mProgressDialog.dismiss();
                        }
                        else
                        {
